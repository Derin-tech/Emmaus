...
import SelectionPage from './components/original/SelectionPage';
import AboutPage from './components/original/AboutPage';
import ContactPage from './components/original/ContactPage';
import StudentDashboard from './components/original/StudentDashboard';
import ProfessorDashboard from './components/original/ProfessorDashboard';
...
export function AppOriginal({ theme, toggleTheme }: { theme: string, toggleTheme: () => void }) {
  // Theme State
