 ...
 * ------------------------------------------------------------------ */
const CARD =
  'rounded-2xl border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] bg-white dark:bg-[#22201F] dark:bg-[#22201F] shadow-[0_1px_2px_rgba(34,32,31,0.04),0_18px_36px_-26px_rgba(34,32,31,0.35)]';
const INPUT =
  'w-full rounded-xl border border-[#E3D8C5] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] px-3.5 py-2.5 text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] placeholder:text-[#B3A996] dark:text-[#7A6F62] outline-none transition focus:border-[#4A0E1B]/50 focus:bg-white dark:bg-[#22201F] dark:bg-[#22201F] focus:ring-4 focus:ring-[#4A0E1B]/10';
const PRIMARY_BTN =
...
const GHOST_BTN =
  'inline-flex items-center justify-center gap-2 rounded-xl border border-[#E3D8C5] dark:border-[#4A433E] bg-white dark:bg-[#22201F] dark:bg-[#22201F] px-4 py-2.5 text-xs font-semibold text-[#4A443E] dark:text-[#C7BCAD] transition-colors hover:bg-[#F6F2EA] dark:bg-[#1A1817] dark:hover:bg-[#1A1817] dark:bg-[#1A1817]';
const MICRO = 'text-[10px] font-bold uppercase tracking-[0.14em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]';
const BACK_BTN =
  'inline-flex items-center gap-1.5 text-xs font-bold text-[#4A0E1B] dark:text-[#F4E7E5] transition-colors hover:text-[#380A14]';
const FIELD_LABEL = 'mb-1.5 block text-[11px] font-bold uppercase tracking-[0.1em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]';
const PILL_SOFT =
  'inline-flex items-center gap-1.5 rounded-lg bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#380A14] px-2.5 py-1.5 text-[11px] font-bold text-[#4A0E1B] dark:text-[#F4E7E5] transition-colors hover:bg-[#EEDAD7]';
const PILL_GHOST =
  'inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold text-[#6E645A] transition-colors hover:bg-[#F6F2EA] dark:bg-[#1A1817] dark:hover:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]';
const PILL_GOLD =
  'inline-flex items-center gap-1.5 rounded-lg bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] px-2.5 py-1.5 text-[11px] font-bold text-[#8A6A16] dark:text-[#E8CD82] transition-colors hover:bg-[#F1E6C9]';
...
const ANN_CAT: Record<AnnouncementCategory, { label: string; cls: string }> = {
  ...
  resource: { label: 'Resource', cls: 'bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16] dark:text-[#E8CD82]' },
...
function DifficultyChip({ level }: { level: 'Easy' | 'Medium' | 'Hard' }) {
  const map = {
    Easy: 'bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16] dark:text-[#E8CD82]',
...
function EmptyState({ label }: { label: string }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-[#E0D5C2] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] px-6 py-16 text-center">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16] dark:text-[#E8CD82]">
        <Search size={22} />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {!selectedExam && (
          <div className="flex flex-col gap-6 pb-12">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#4A0E1B] to-[#7C2532] p-7 text-white shadow-[0_22px_44px_-24px_rgba(74,14,27,0.75)] sm:p-10 animate-[fadeInUp_0.8s_ease-out_forwards]">
              ...
              <div className="relative flex flex-col items-center gap-7 text-center md:flex-row md:items-center md:gap-9 md:text-left">
                ...
                <div className="relative shrink-0 animate-[fadeInUp_0.8s_ease-out_forwards]" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
                  ...
                  <span className="absolute -bottom-2 -right-2 flex h-10 w-10 items-center justify-center rounded-2xl border-4 border-[#4A0E1B] bg-white dark:bg-[#22201F] dark:bg-[#22201F] text-[#4A0E1B] dark:text-[#F4E7E5]">
                    <BookOpen size={18} />
                  </span>
                </div>
                ...
                <div className="max-w-xl">
                  ...
                  <div className="mt-5 flex flex-wrap justify-center gap-2 md:justify-start">
                    {[
                      ...
                      <span
                        key={i}
                        className="inline-flex items-center gap-1.5 rounded-full border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F]/10 px-3 py-1.5 text-[11px] font-semibold text-white/90 hover:border-[#D9C2A2] hover:shadow-[0_0_12px_rgba(217,194,162,0.3)] hover:-translate-y-0.5 transition-all duration-300 animate-[fadeInUp_0.8s_ease-out_forwards]"
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-4">
              {exams.map((exam) => (
                <button
                  ...
                  className="group relative flex w-full max-w-[340px] flex-col overflow-hidden rounded-[24px] border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] bg-white dark:bg-[#22201F] dark:bg-[#22201F] p-6 text-left shadow-[0_4px_12px_rgba(34,32,31,0.04)] transition-all duration-[220ms] ease-out hover:-translate-y-[6px] hover:shadow-[0_20px_40px_rgba(74,14,27,0.12)] sm:w-[calc(50%-12px)] lg:w-[340px] h-[230px]"
                >
                  ...
                  <div className="flex items-start justify-between w-full">
                    <span className="flex h-12 w-12 items-center justify-center rounded-[14px] bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5] transition-colors duration-[220ms] ease-out group-hover:bg-[#F7EFD9] dark:bg-[#362A0D] dark:group-hover:bg-[#362A0D] dark:hover:bg-[#362A0D] dark:bg-[#362A0D] group-hover:text-[#8A6A16] dark:group-hover:text-[#E8CD82] dark:text-[#E8CD82]">
                      {renderExamIcon(exam.icon)}
                    </span>
                    <span className="dash-mono rounded-full border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] px-2.5 py-1 text-[10px] font-medium text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]">
            ...
            <div className="mt-12 grid gap-6 grid-cols-1 lg:grid-cols-12 items-stretch border-t border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] pt-10">
              ...
              <div className="lg:col-span-6 xl:col-span-7 grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
                ...
                {/* Quick Statistics */}
                <div className="rounded-[24px] border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] bg-white dark:bg-[#22201F] dark:bg-[#22201F] p-6 shadow-[0_4px_12px_rgba(34,32,31,0.02)] flex flex-col transition-all duration-[220ms] hover:border-[#D9C2A2]">
                  <h3 className="mb-6 text-[10px] font-bold uppercase tracking-[0.14em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]">Platform Stats</h3>
                  <div className="flex-1 flex flex-col justify-center gap-4.5">
                    <div className="flex items-center justify-between group"><span className="text-sm font-semibold text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#A89F91]">Study Notes</span><span className="dash-mono text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{notes.length}</span></div>
                    <div className="h-px w-full bg-[#F2ECDF] dark:bg-[#332E2C]" />
                    <div className="flex items-center justify-between group"><span className="text-sm font-semibold text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#A89F91]">Video Lectures</span><span className="dash-mono text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{videos.length}</span></div>
                    <div className="h-px w-full bg-[#F2ECDF] dark:bg-[#332E2C]" />
                    <div className="flex items-center justify-between group"><span className="text-sm font-semibold text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#A89F91]">Practice Sheets</span><span className="dash-mono text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{practiceSheets.length}</span></div>
                    <div className="h-px w-full bg-[#F2ECDF] dark:bg-[#332E2C]" />
                    <div className="flex items-center justify-between group"><span className="text-sm font-semibold text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#A89F91]">PYQs</span><span className="dash-mono text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{pyqs.length}</span></div>
                  </div>
                </div>

                {/* Popular Resources */}
                <div className="rounded-[24px] border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] bg-white dark:bg-[#22201F] dark:bg-[#22201F] p-6 shadow-[0_4px_12px_rgba(34,32,31,0.02)] flex flex-col transition-all duration-[220ms] hover:border-[#D9C2A2]">
                  <h3 className="mb-6 text-[10px] font-bold uppercase tracking-[0.14em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]">Popular Now</h3>
                  <div className="flex-1 flex flex-col gap-4">
                    {popularResources.slice(0, 4).map(res => (
                      <div key={res.id} className="cursor-pointer group flex items-start gap-3.5" onClick={() => setActivePdfViewer({ title: res.title, fileUrl: res.fileUrl })}>
                         <span className="flex mt-0.5 shrink-0 h-8 w-8 items-center justify-center rounded-[10px] bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5] transition-colors group-hover:bg-[#4A0E1B] dark:group-hover:bg-[#5C1122] group-hover:text-white">
                           <Download size={12} />
                         </span>
                         <div>
                           <p className="text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] line-clamp-1 group-hover:text-[#4A0E1B] dark:group-hover:text-[#F4E7E5] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] transition-colors">{res.title}</p>
                           <p className="text-[11px] font-medium text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] mt-1">{res.course.toUpperCase()}</p>
                         </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="rounded-[24px] border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] bg-white dark:bg-[#22201F] dark:bg-[#22201F] p-6 shadow-[0_4px_12px_rgba(34,32,31,0.02)] sm:col-span-2 transition-all duration-[220ms] hover:border-[#D9C2A2]">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]">Recently Added</h3>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {recentUploads.slice(0, 4).map((item, i) => (
                      <div key={i} className="flex items-center gap-3.5 p-3.5 rounded-2xl border border-[#F2ECDF] dark:border-[#383330] dark:border-[#2A2725] hover:border-[#EAE1D2] dark:border-[#4A433E] dark:hover:border-[#4A433E] dark:border-[#383330] hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:hover:bg-[#2A2725] dark:bg-[#2A2725] hover:shadow-sm transition-all cursor-pointer">
                         <span className="flex shrink-0 h-9 w-9 items-center justify-center rounded-[10px] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] text-[#4A0E1B] dark:text-[#F4E7E5]">
                           {item.type === 'Note' ? <BookOpen size={14} /> : <VideoIcon size={14} />}
                         </span>
                         <div className="min-w-0">
                           <p className="text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] truncate">{item.title}</p>
                           <p className="text-[11px] font-medium text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] mt-1">{item.type}</p>
                         </div>
                      </div>
                    ))}
                  </div>
        ...
        {selectedExam && !activeCategory && (
          <div>
            ...
            <div className="mb-10 border-b border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] pb-8">
              ...
              {categoryCards.map((cat) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]">{cat.icon}</span>
                    {cat.count !== null && (
                      <span className="dash-mono rounded-full border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] px-2.5 py-1 text-[11px] font-medium text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]">
                        {cat.count} {cat.unit}
                      </span>
                    )}
                  </div>
        ...
        {selectedExam && activeCategory === 'notes' && (
          <div className="animate-[fadeInUp_0.4s_ease-out_forwards]">
            ...
            <div className="relative overflow-hidden rounded-[24px] bg-gradient-to-br from-[#4A0E1B] to-[#7C2532] p-6 sm:p-8 text-white shadow-[0_12px_24px_-12px_rgba(74,14,27,0.5)] mb-8">
              ...
              <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex shrink-0 items-center gap-4">
                  <div className="rounded-2xl bg-white dark:bg-[#22201F] dark:bg-[#22201F]/10 p-4 backdrop-blur-md border border-white/20 text-center min-w-[100px]">
            ...
            <div className={`${CARD} mb-6 flex flex-col p-2 sm:flex-row sm:items-center sm:justify-between gap-2 overflow-hidden`}>
                  ...
                  <button
                    ...
                    className={`whitespace-nowrap rounded-lg px-4 py-2 text-[11px] font-bold transition-all ${
                      selectedSubject === subject
                        ...
                        : 'text-[#6E645A] hover:bg-[#F6F2EA] dark:bg-[#1A1817] dark:hover:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]'
                    }`}
                  >
              ...
              <div className="flex items-center gap-2 border-t border-[#F2ECDF] dark:border-[#383330] dark:border-[#2A2725] pt-2 sm:border-none sm:pt-0 pl-2 pr-2">
                {/* Search */}
                <div className="relative w-full sm:w-56 lg:w-64">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-[#E3D8C5] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] py-2 pl-9 pr-3 text-xs text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] placeholder:text-[#B3A996] dark:text-[#7A6F62] outline-none transition focus:border-[#4A0E1B]/50 focus:bg-white dark:bg-[#22201F] dark:bg-[#22201F] focus:ring-2 focus:ring-[#4A0E1B]/10"
                  />
                </div>
                ...
                <button 
                  ...
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-[#E3D8C5] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] text-[#6E645A] transition-colors hover:bg-white dark:bg-[#22201F] dark:bg-[#22201F] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]"
                ...
                {/* View Toggle (Visual) */}
                <div className="flex h-9 shrink-0 items-center rounded-lg border border-[#E3D8C5] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] p-1">
                  <button
                    onClick={() => setNoteViewMode('grid')}
                    className={`flex h-full w-8 items-center justify-center rounded-md transition-all ${noteViewMode === 'grid' ? 'bg-white dark:bg-[#22201F] dark:bg-[#22201F] text-[#4A0E1B] dark:text-[#F4E7E5] shadow-sm' : 'text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]'}`}
                  >
                    <LayoutGrid size={14} />
                  </button>
                  <button
                    onClick={() => setNoteViewMode('list')}
                    className={`flex h-full w-8 items-center justify-center rounded-md transition-all ${noteViewMode === 'list' ? 'bg-white dark:bg-[#22201F] dark:bg-[#22201F] text-[#4A0E1B] dark:text-[#F4E7E5] shadow-sm' : 'text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]'}`}
                  >
                    <List size={14} />
                  </button>
                </div>
                ...
                {filteredNotes.map((note) => (
                  <div key={note.id} className={`${CARD} flex flex-col p-5 group transition-all duration-[220ms] hover:-translate-y-1 hover:shadow-[0_12px_24px_-12px_rgba(34,32,31,0.15)]`}>
                    <div className="flex items-start gap-3">
                      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5] transition-colors group-hover:bg-[#4A0E1B] dark:group-hover:bg-[#5C1122] group-hover:text-white">
                        <FileText size={18} />
                      </span>
                      <div className="min-w-0 flex-1">
                        <div className="mb-1.5 flex flex-wrap items-center gap-1.5">
                          <span className="inline-block rounded-full border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]">
                            {note.chapter}
                          </span>
                          <SubjectBadge subject={note.subject} />
                        </div>
                        <h4 className="text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] truncate group-hover:text-[#4A0E1B] dark:group-hover:text-[#F4E7E5] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] transition-colors">
                          {note.title}
                        </h4>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-[#F2ECDF] dark:border-[#383330] dark:border-[#2A2725] pt-4">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => setActivePdfViewer({ title: note.title, fileUrl: note.fileUrl })} className="flex h-8 w-8 items-center justify-center rounded-lg border border-[#E3D8C5] dark:border-[#4A433E] bg-white dark:bg-[#22201F] dark:bg-[#22201F] text-[#6E645A] transition-colors hover:bg-[#F6F2EA] dark:bg-[#1A1817] dark:hover:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">
                          <Eye size={14} />
                        </button>
                        <button onClick={() => handleDownloadFile(note.id, note.fileUrl)} className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5] transition-colors hover:bg-[#EEDAD7]">
                          <Download size={14} />
                        </button>
                      </div>
                    </div>
                  ...
                  <div key={video.id} className={`${CARD} group flex flex-col overflow-hidden`}>
                    <div className="relative aspect-video w-full overflow-hidden bg-[#EFE7D8]">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-[#22201F]/25 opacity-80 transition-opacity group-hover:opacity-100">
                        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white dark:bg-[#22201F] dark:bg-[#22201F]/95 text-[#4A0E1B] dark:text-[#F4E7E5] shadow-lg transition-transform group-hover:scale-105">
              ...
              <div className={`${CARD} overflow-hidden`}>
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[720px] text-left text-sm">
                    <thead>
                      <tr className="border-b border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725]">
                    ...
                    <tbody className="divide-y divide-[#F2ECDF]">
                      {filteredPyqs.map((pyq) => (
                        <tr key={pyq.id} className="transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:hover:bg-[#2A2725] dark:bg-[#2A2725]">
                          ...
                          <td className="px-5 py-3.5 text-right">
                            <div className="inline-flex justify-end gap-1.5">
                              <button onClick={() => setActivePdfViewer({ title: `PYQ Question · ${pyq.chapter} (${pyq.year})`, fileUrl: pyq.questionUrl })} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] transition-colors hover:bg-[#F4E7E5] dark:bg-[#38151A] dark:hover:bg-[#380A14] dark:bg-[#380A14] hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5]"><Eye size={15} /></button>
                              <button onClick={() => triggerDownload(pyq.questionUrl)} className={PILL_SOFT}><Download size={11} /> {pyq.questionSize}</button>
                            </div>
                          </td>
                          <td className="px-5 py-3.5 text-right">
                            <div className="inline-flex justify-end gap-1.5">
                              <button onClick={() => setActivePdfViewer({ title: `PYQ Solution · ${pyq.chapter} (${pyq.year})`, fileUrl: pyq.solutionUrl })} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] transition-colors hover:bg-[#F7EFD9] dark:bg-[#362A0D] dark:hover:bg-[#362A0D] dark:bg-[#362A0D] hover:text-[#8A6A16] dark:text-[#E8CD82]"><Eye size={15} /></button>
                ...
                {filteredSheets.map((sheet) => (
                  <div key={sheet.id} className={`${CARD} flex flex-col p-5`}>
                    <div className="flex items-start justify-between gap-3">
                      <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16] dark:text-[#E8CD82]"><FileText size={18} /></span>
                      <div className="flex flex-col items-end gap-1">
                        <span className="rounded-full border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#332E2C] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2725] px-2.5 py-1 text-[10px] font-bold text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91]">{sheet.chapter}</span>
            ...
            <div className="grid gap-8 lg:grid-cols-12">
              ...
              <div className="lg:col-span-7">
                <div className={`${CARD} p-6`}>
                  ...
                  {doubtSubmitted && (
                    <div className="mt-5 flex items-start gap-2.5 rounded-xl border border-[#E7D7AE] bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] px-4 py-3 text-sm text-[#8A6A16] dark:text-[#E8CD82]">
              ...
              <div className="lg:col-span-5">
                ...
                <div className="mt-5 space-y-2.5">
                  {faqs.map((faq) => {
                    ...
                    return (
                      <div key={faq.id} className="overflow-hidden rounded-xl border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#383330] bg-white dark:bg-[#22201F] dark:bg-[#22201F]">
                        <button
                          onClick={() => setExpandedFaqId(isExpanded ? null : faq.id)}
                          className="flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:hover:bg-[#2A2725] dark:bg-[#2A2725]"
                        >
                        ...
                        {isExpanded && (
                          <div className="border-t border-[#F2ECDF] dark:border-[#383330] dark:border-[#2A2725] px-4 py-3.5 text-sm leading-relaxed text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#A89F91]">{faq.answer}</div>
                        )}
                      </div>
                    );
                  })}
          ...
          <div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className={`${CARD} flex flex-col p-6`}>
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]"><FileSpreadsheet size={20} /></span>
              ...
              <div className={`${CARD} flex flex-col p-6`}>
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16] dark:text-[#E8CD82]"><BookOpen size={20} /></span>
