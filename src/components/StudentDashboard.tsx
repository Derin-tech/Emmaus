 ...
 * ------------------------------------------------------------------ */
const CARD =
  'rounded-2xl border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] shadow-[0_1px_2px_rgba(34,32,31,0.04),0_18px_36px_-26px_rgba(34,32,31,0.35)]';
const INPUT =
  'w-full rounded-xl border border-[#E3D8C5] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-3.5 py-2.5 text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] placeholder:text-[#B3A996] outline-none transition focus:border-[#4A0E1B]/50 focus:bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] focus:ring-4 focus:ring-[#4A0E1B]/10';
const PRIMARY_BTN =
...
const GHOST_BTN =
  'inline-flex items-center justify-center gap-2 rounded-xl border border-[#E3D8C5] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-4 py-2.5 text-xs font-semibold text-[#4A443E] transition-colors hover:bg-[#F6F2EA] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]';
...
const FIELD_LABEL = 'mb-1.5 block text-[11px] font-bold uppercase tracking-[0.1em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]';
const PILL_SOFT =
  'inline-flex items-center gap-1.5 rounded-lg bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] px-2.5 py-1.5 text-[11px] font-bold text-[#4A0E1B] transition-colors hover:bg-[#EEDAD7]';
const PILL_GHOST =
  'inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold text-[#6E645A] transition-colors hover:bg-[#F6F2EA] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]';
const PILL_GOLD =
  'inline-flex items-center gap-1.5 rounded-lg bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] px-2.5 py-1.5 text-[11px] font-bold text-[#8A6A16] transition-colors hover:bg-[#F1E6C9]';
...
function SubjectBadge({ subject }: { subject: string }) {
  ...
  if (!s) return <span className="text-[9px] font-bold uppercase tracking-wider text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{subject}</span>;
  return (
...
function EmptyState({ label }: { label: string }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-[#E0D5C2] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-6 py-16 text-center">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]">
        <Search size={22} />
      </div>
      <p className="mt-4 text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Nothing found</p>
      <p className="mt-1 max-w-sm text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{label}</p>
    </div>
  );
}
...
function StudentDashboardContent({
  ...
  return (
    <div className="dash-root min-h-screen bg-[#F6F2EA] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] py-12 text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#4A0E1B] to-[#7C2532] p-7 text-white shadow-[0_22px_44px_-24px_rgba(74,14,27,0.75)] sm:p-10 animate-[fadeInUp_0.8s_ease-out_forwards]">
              ...
              <div className="relative flex flex-col items-center gap-7 text-center md:flex-row md:items-center md:gap-9 md:text-left">
                ...
                <div className="relative shrink-0 animate-[fadeInUp_0.8s_ease-out_forwards]" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
                  ...
                  <span className="absolute -bottom-2 -right-2 flex h-10 w-10 items-center justify-center rounded-2xl border-4 border-[#4A0E1B] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] text-[#4A0E1B]">
                    <BookOpen size={18} />
                  </span>
                </div>
                ...
                <div className="max-w-xl">
                  ...
                  <div className="mt-5 flex flex-wrap justify-center gap-2 md:justify-start">
                    {[
                      ...
                      <span
                        key={i}
                        className="inline-flex items-center gap-1.5 rounded-full border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]/10 px-3 py-1.5 text-[11px] font-semibold text-white/90 hover:border-[#D9C2A2] hover:shadow-[0_0_12px_rgba(217,194,162,0.3)] hover:-translate-y-0.5 transition-all duration-300 animate-[fadeInUp_0.8s_ease-out_forwards]"
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-4">
              {exams.map((exam) => (
                <button
                  ...
                  className="group relative flex w-full max-w-[340px] flex-col overflow-hidden rounded-[24px] border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] p-6 text-left shadow-[0_4px_12px_rgba(34,32,31,0.04)] transition-all duration-[220ms] ease-out hover:-translate-y-[6px] hover:shadow-[0_20px_40px_rgba(74,14,27,0.12)] sm:w-[calc(50%-12px)] lg:w-[340px] h-[230px]"
                >
                  ...
                  <div className="flex items-start justify-between w-full">
                    <span className="flex h-12 w-12 items-center justify-center rounded-[14px] bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] text-[#4A0E1B] transition-colors duration-[220ms] ease-out group-hover:bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] group-hover:text-[#8A6A16]">
                      {renderExamIcon(exam.icon)}
                    </span>
                    <span className="dash-mono rounded-full border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-2.5 py-1 text-[10px] font-medium text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
                  ...
                  <h3 className="dash-serif mt-5 text-xl font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{exam.title}</h3>
                  <p className="mt-2 text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] line-clamp-1">{exam.description}</p>
        ...
        {(selectedExam || activeCategory) && (
          <nav className="mb-6 flex flex-wrap items-center gap-1.5 text-xs font-semibold text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
        ...
        {selectedExam && !activeCategory && (
          <div>
            ...
            <div className="mb-10 border-b border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] pb-8">
              <div className="flex items-center gap-4">
                ...
                <h2 className="dash-serif text-3xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] sm:text-4xl">
                  {currentExamInfo?.title} Library
                </h2>
              </div>
              <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{currentExamInfo?.description}</p>
            </div>
              ...
              {categoryCards.map((cat) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] text-[#4A0E1B]">{cat.icon}</span>
                    {cat.count !== null && (
                      <span className="dash-mono rounded-full border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-2.5 py-1 text-[11px] font-medium text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
                        {cat.count} {cat.unit}
                      </span>
                    )}
                  </div>
                  <h3 className="dash-serif mt-4 text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{cat.title}</h3>
                  <p className="mt-1.5 text-sm leading-relaxed text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{cat.desc}</p>
                </button>
              ))}
            </div>
          </div>
        ...
        {selectedExam && activeCategory === 'notes' && (
          <div key={selectedExam} className="animate-[fadeInUp_0.4s_ease-out_forwards]">
            ...
            {/* Dynamic Breadcrumbs */}
            <div className="mb-4 flex items-center gap-2 text-xs font-medium text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
              <button onClick={handleBackToExams} className="transition-colors hover:text-[#4A0E1B]">Library</button>
              <span>›</span>
              <button onClick={handleBackToCategories} className="transition-colors hover:text-[#4A0E1B]">{currentExamInfo?.title}</button>
              <span>›</span>
              <span className="text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Study Notes</span>
            </div>
                  ...
                  {currentExamInfo?.quickStats ? (
                    <div className="mt-4 grid grid-cols-2 sm:flex sm:flex-row gap-3">
                      {currentExamInfo.quickStats.map((stat, idx) => {
                        ...
                        return (
                          <div key={idx} className="flex items-center gap-2.5 rounded-[12px] border border-white/10 bg-white dark:bg-[#22201F] dark:bg-[#22201F]/5 px-3 py-2.5 backdrop-blur-md transition-all hover:bg-white dark:bg-[#22201F] dark:bg-[#22201F]/10 group">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-[10px] w-full sm:w-auto">
                ...
                <div className={`relative flex items-center transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${isSearchFocused ? 'w-full sm:w-[320px]' : 'w-full sm:w-[240px]'}`}>
                  ...
                  <input
                    ...
                    className="w-full h-[40px] rounded-[10px] border-[1.5px] border-transparent bg-[#FAF6F1] pl-[38px] pr-[14px] text-[13px] text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] placeholder:text-[#B0A296] outline-none transition-all duration-[250ms] focus:border-[#D9A9A0] focus:bg-[#FFFFFF] focus:shadow-[0_0_0_4px_rgba(217,169,160,0.15)]"
                  />
                  ...
                  <div className="relative w-full sm:w-auto" ref={sortDropdownRef}>
                    <button
                      ...
                      className={`h-[40px] w-full sm:w-auto flex items-center justify-between gap-[8px] rounded-[10px] border-[1.5px] bg-[#FAF6F1] px-[14px] text-[13px] font-medium text-[#3A2E28] transition-all duration-[250ms] ${
                        isSortDropdownOpen
                          ? 'border-[#D9A9A0] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] shadow-[0_0_0_4px_rgba(217,169,160,0.15)]'
                    ...
                    <AnimatePresence>
                      {isSortDropdownOpen && (
                        <motion.div
                          ...
                          className="absolute right-0 top-[calc(100%+8px)] z-50 w-full sm:min-w-[180px] rounded-[10px] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] p-[6px] shadow-[0_8px_24px_rgba(0,0,0,0.12)] border border-[#F0E9E2]"
                        >
                          {[
                  ...
                  <div className="flex relative bg-[#F7F2EC] rounded-[10px] p-[3px] h-[40px] shrink-0 ml-auto sm:ml-0">
                    ...
                    >
                      {noteViewMode === 'grid' && (
                        <motion.div 
                          layoutId="view-pill"
                          className="absolute inset-0 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] rounded-[7px] shadow-[0_1px_3px_rgba(0,0,0,0.1)] -z-10"
                          transition={{ type: "spring", bounce: 0.2, duration: 0.4 }}
                        />
                      )}
                      <LayoutGrid size={14} />
                  ...
                  <div key={note.id} className="flex flex-col h-full p-[20px] rounded-[16px] bg-[#FFFFFF] shadow-[0_1px_3px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.08)] hover:-translate-y-[2px] transition-all duration-[0.15s] ease-[ease] group">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1 pt-0.5">
                        ...
                        <h4 className="text-[15px] font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] line-clamp-2 leading-[1.3]">
                          {note.title}
                        </h4>
                      </div>
                    </div>
                    ...
                    <div className="mt-auto pt-[16px]">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-[8px]">
                          <button onClick={() => setActivePdfViewer({ title: note.title, fileUrl: note.fileUrl })} className="flex h-[40px] items-center justify-center rounded-[8px] border border-[#E0D5CC] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-[16px] text-[13px] font-bold text-[#5A2436] transition-all hover:bg-[#F9F7F5]">
        ...
        {selectedExam && activeCategory === 'videos' && (
          <div>
            ...
            <div className="mt-4 mb-6">
              ...
              <h2 className="dash-serif mt-1 text-2xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Video lectures</h2>
            </div>
                  ...
                  <div key={video.id} className={`${CARD} group flex flex-col overflow-hidden`}>
                    <div className="relative aspect-video w-full overflow-hidden bg-[#EFE7D8]">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-[#22201F]/25 opacity-80 transition-opacity group-hover:opacity-100">
                        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]/95 text-[#4A0E1B] shadow-lg transition-transform group-hover:scale-105">
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      <h4 className="mt-3.5 text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] line-clamp-1">{video.title}</h4>
                      <p className="mt-1 text-xs leading-relaxed text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] line-clamp-2">{video.description}</p>
        ...
        {selectedExam && activeCategory === 'pyqs' && (
          <div>
            ...
            <div className="mt-4 mb-6">
              ...
              <h2 className="dash-serif mt-1 text-2xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Previous year questions</h2>
            </div>
                  ...
                  <table className="w-full min-w-[720px] text-left text-sm">
                    <thead>
                      <tr className="border-b border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726]">
                        <th className="px-5 py-3 text-[10px] font-bold uppercase tracking-[0.12em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Subject & chapter</th>
                        <th className="px-5 py-3 text-[10px] font-bold uppercase tracking-[0.12em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Year</th>
                        <th className="px-5 py-3 text-[10px] font-bold uppercase tracking-[0.12em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Difficulty</th>
                        <th className="px-5 py-3 text-right text-[10px] font-bold uppercase tracking-[0.12em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Question paper</th>
                        <th className="px-5 py-3 text-right text-[10px] font-bold uppercase tracking-[0.12em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Step solution</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-[#F2ECDF]">
                      {filteredPyqs.map((pyq) => (
                        <tr key={pyq.id} className="transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726]">
                          <td className="px-5 py-3.5">
                            <SubjectBadge subject={pyq.subject} />
                            <span className="mt-0.5 block text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{pyq.chapter}</span>
                          </td>
                          ...
                          <td className="px-5 py-3.5 text-right">
                            <div className="inline-flex justify-end gap-1.5">
                              <button onClick={() => setActivePdfViewer({ title: `PYQ Question · ${pyq.chapter} (${pyq.year})`, fileUrl: pyq.questionUrl })} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] transition-colors hover:bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] hover:text-[#4A0E1B]"><Eye size={15} /></button>
                              <button onClick={() => triggerDownload(pyq.questionUrl)} className={PILL_SOFT}><Download size={11} /> {pyq.questionSize}</button>
                            </div>
                          </td>
                          <td className="px-5 py-3.5 text-right">
                            <div className="inline-flex justify-end gap-1.5">
                              <button onClick={() => setActivePdfViewer({ title: `PYQ Solution · ${pyq.chapter} (${pyq.year})`, fileUrl: pyq.solutionUrl })} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] transition-colors hover:bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] hover:text-[#8A6A16]"><Eye size={15} /></button>
        ...
        {selectedExam && activeCategory === 'sheets' && (
          <div>
            ...
            <div className="mt-4 mb-6">
              ...
              <h2 className="dash-serif mt-1 text-2xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Practice sheets</h2>
            </div>
                ...
                {filteredSheets.map((sheet) => (
                  <div key={sheet.id} className={`${CARD} flex flex-col p-5`}>
                    <div className="flex items-start justify-between gap-3">
                      <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]"><FileText size={18} /></span>
                      <div className="flex flex-col items-end gap-1">
                        <span className="rounded-full border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-2.5 py-1 text-[10px] font-bold text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{sheet.chapter}</span>
                        <SubjectBadge subject={sheet.subject} />
                      </div>
                    </div>
                    <h4 className="mt-4 text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{sheet.title}</h4>
                    <p className="mt-1 text-xs leading-relaxed text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{sheet.description}</p>
                    <div className="mt-4 flex items-center justify-between border-t border-[#F2ECDF] dark:border-[#383330] dark:border-[#383330] dark:border-[#383330] pt-4">
        ...
        {selectedExam && activeCategory === 'doubts' && (
          <div>
            ...
            <div className="mt-4 mb-8">
              ...
              <h2 className="dash-serif mt-1 text-2xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Ask a doubt</h2>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-12">
              ...
              <div className="lg:col-span-7">
                <div className={`${CARD} p-6`}>
                  <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Submit an academic doubt</h3>
                  <p className="mt-1 text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
                    Explain your concept difficulty or problem blocker. Prof. Ajesh Joe will review it and provide step-by-step guidance.
                  </p>

                  {doubtSubmitted && (
                    <div className="mt-5 flex items-start gap-2.5 rounded-xl border border-[#E7D7AE] bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] px-4 py-3 text-sm text-[#8A6A16]">
              ...
              <div className="lg:col-span-5">
                <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Frequently asked questions</h3>
                <p className="mt-1 text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Quick references on downloads, syllabus revisions and response timelines.</p>
                <div className="mt-5 space-y-2.5">
                  {faqs.map((faq) => {
                    const isExpanded = expandedFaqId === faq.id;
                    return (
                      <div key={faq.id} className="overflow-hidden rounded-xl border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]">
                        <button
                          onClick={() => setExpandedFaqId(isExpanded ? null : faq.id)}
                          className="flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726]"
                        >
                          <span>{faq.question}</span>
                          <ChevronDown size={16} className={`shrink-0 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] transition-transform ${isExpanded ? 'rotate-180' : ''}`} />
                        </button>
                        {isExpanded && (
                          <div className="border-t border-[#F2ECDF] dark:border-[#383330] dark:border-[#383330] dark:border-[#383330] px-4 py-3.5 text-sm leading-relaxed text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#C7BCAD]">{faq.answer}</div>
                        )}
                      </div>
                    );
                  })}
        ...
        {selectedExam && activeCategory === 'resources' && (
          <div>
            ...
            <div className="mt-4 mb-8">
              ...
              <h2 className="dash-serif mt-1 text-2xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Additional resources</h2>
            </div>

            <div className="grid gap-6 sm:grid-cols-2">
              <div className={`${CARD} flex flex-col p-6`}>
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] text-[#4A0E1B]"><FileSpreadsheet size={20} /></span>
                <h3 className="dash-serif mt-4 text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Syllabus blueprints & topic weights</h3>
                <p className="mt-1.5 text-sm leading-relaxed text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
              ...
              <div className={`${CARD} flex flex-col p-6`}>
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]"><BookOpen size={20} /></span>
                <h3 className="dash-serif mt-4 text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Formula & fundamental constant sheets</h3>
                <p className="mt-1.5 text-sm leading-relaxed text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
