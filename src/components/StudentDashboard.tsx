    ...
    <div className="bg-[#111112] py-12 transition-colors duration-300 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {(selectedExam || activeCategory) && (
          <nav className="mb-6 flex flex-wrap items-center space-x-2 font-mono text-[11px] font-medium uppercase tracking-wider text-gray-400 dark:text-slate-500">
            <button onClick={handleBackToExams} className="hover:text-blue-500">Library</button>
            {selectedExam && (
              <>
                <span>/</span>
                <button onClick={handleBackToCategories} className={`hover:text-blue-500 ${!activeCategory ? 'text-blue-600 dark:text-blue-400 font-bold' : ''}`}>
        ...
        {selectedExam && !activeCategory && (
          <div>
            {/* Header Area */}
            <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-gray-100 pb-8 mb-10 dark:border-slate-800">
              <div className="space-y-1.5">
                <button
                  onClick={handleBackToExams}
                  className="inline-flex items-center space-x-1.5 text-xs font-semibold text-gray-500 hover:text-blue-600 dark:text-slate-400"
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div
                ...
                className="group cursor-pointer rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:border-blue-200 hover:-translate-y-0.5 dark:border-slate-800 dark:bg-slate-900"
                id="cat-card-notes"
              >
                ...
                <h3 className="mt-4 text-base font-bold text-gray-900 dark:text-white">📚 Study Notes</h3>
              ...
              >
                ...
                <h3 className="mt-4 text-base font-bold text-gray-900 dark:text-white">🎥 Video Lectures</h3>
                <p className="mt-1.5 text-xs text-gray-400 dark:text-slate-500 leading-relaxed">
              ...
              >
                ...
                <h3 className="mt-4 text-base font-bold text-gray-900 dark:text-white">📄 Previous Year Questions</h3>
                <p className="mt-1.5 text-xs text-gray-400 dark:text-slate-500 leading-relaxed">
              ...
              >
                ...
                <h3 className="mt-4 text-base font-bold text-gray-900 dark:text-white">📝 Practice Sheets</h3>
                <p className="mt-1.5 text-xs text-gray-400 dark:text-slate-500 leading-relaxed">
              ...
              >
                ...
                <h3 className="mt-4 text-base font-bold text-gray-900 dark:text-white">❓ Doubts Submission</h3>
                <p className="mt-1.5 text-xs text-gray-400 dark:text-slate-500 leading-relaxed">
              ...
              >
                ...
                <h3 className="mt-4 text-base font-bold text-gray-900 dark:text-white">📂 Additional Resources</h3>
                <p className="mt-1.5 text-xs text-gray-400 dark:text-slate-500 leading-relaxed">
        ...
        {selectedExam && activeCategory === 'notes' && (
          <div>
            ...
            <div className="flex flex-col space-y-4 border-b border-gray-100 pb-6 mb-8 dark:border-slate-800">
              <div className="flex items-center justify-between">
                <button onClick={handleBackToCategories} className="inline-flex items-center space-x-1 font-semibold text-xs text-gray-500 hover:text-blue-500">
                  <ArrowLeft size={12} />
              ...
              <div className="grid gap-4 md:grid-cols-12">
                <div className="relative md:col-span-8">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-gray-50/30 pl-10 pr-4 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:bg-white dark:border-slate-800 dark:bg-slate-950/30 dark:focus:border-blue-400"
                  />
                </div>
                <div className="relative md:col-span-4">
                  ...
                  <select
                    ...
                    className="w-full appearance-none rounded-xl border border-gray-200 bg-gray-50/30 pl-10 pr-4 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:bg-white dark:border-slate-800 dark:bg-slate-950/30 dark:focus:border-blue-400"
                  >
            ...
            {filteredNotes.length === 0 ? (
              <div className="text-center py-12 rounded-2xl border border-dashed border-gray-200 dark:border-slate-800">
                <p className="text-sm text-gray-400 dark:text-slate-500">No study notes found matching your filters.</p>
              </div>
            ) : (
              <div className="space-y-8">
                ...
                {Array.from(new Set(filteredNotes.map(n => n.subject))).map((subj) => (
                  <div key={subj} className="space-y-4">
                    <h3 className="border-b border-gray-100 pb-2 text-lg font-bold text-gray-800 dark:border-slate-800 dark:text-slate-200">
                      {subj}
                    </h3>
                    
                    <div className="grid gap-4 sm:grid-cols-2">
                      {filteredNotes.filter(n => n.subject === subj).map((note) => (
                        <div key={note.id} className="group rounded-2xl border border-gray-150 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                          <div className="flex items-start justify-between">
                            ...
                            <span className="font-mono text-[9px] font-bold text-gray-400 dark:text-slate-500 uppercase">
                              {note.chapter}
                            </span>
                          </div>

                          <h4 className="mt-4 text-sm font-bold text-gray-900 dark:text-white line-clamp-1">{note.title}</h4>
                          <p className="mt-1 text-xs text-gray-500 dark:text-slate-400 line-clamp-2">{note.description}</p>
                          
                          <div className="mt-5 flex items-center justify-between border-t border-gray-50 pt-4 dark:border-slate-800">
                            <span className="font-mono text-[10px] text-gray-400 dark:text-slate-500">{note.fileSize} • {note.downloadCount || 0} views</span>
                            <div className="flex space-x-2">
                              <button
                                onClick={() => setActivePdfViewer({ title: note.title, fileUrl: note.fileUrl })}
                                className="inline-flex items-center space-x-1 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold text-gray-600 hover:bg-gray-50 dark:text-slate-300 dark:hover:bg-slate-800"
                              >
                                <Eye size={12} />
                                <span>View</span>
                              </button>
        ...
        {selectedExam && activeCategory === 'videos' && (
          <div>
            ...
            {filteredVideos.length === 0 ? (
              <div className="text-center py-12 rounded-2xl border border-dashed border-gray-200 dark:border-slate-800">
                <p className="text-sm text-gray-400 dark:text-slate-500">No lecture recordings found matching your filters.</p>
              </div>
            ) : (
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {filteredVideos.map((video) => (
                  <div key={video.id} className="group overflow-hidden rounded-2xl border border-gray-150 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    ...
                    <div className="relative aspect-video w-full bg-gray-100 overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-black/30 flex items-center justify-center opacity-70 group-hover:opacity-100 transition-opacity">
                        <div className="flex h-11 w-11 items-center justify-center rounded-full bg-white/90 text-blue-600 shadow-md transform group-hover:scale-105 transition-transform">
                    ...
                    <div className="p-5">
                      <div className="flex items-center justify-between">
                        <span className="rounded-md bg-blue-50 px-2 py-0.5 font-mono text-[9px] font-bold text-blue-600 dark:bg-blue-950/50 dark:text-blue-400">
                          {video.subject}
                        </span>
                        <span className="font-mono text-[9px] text-gray-400 dark:text-slate-500 uppercase">{video.chapter}</span>
                      </div>
                      <h4 className="mt-3.5 text-sm font-bold text-gray-900 dark:text-white line-clamp-1">{video.title}</h4>
                      <p className="mt-1 text-xs text-gray-500 dark:text-slate-400 line-clamp-2">{video.description}</p>
                      
                      <button
                        onClick={() => setActiveVideoModal(video)}
                        className="mt-5 w-full inline-flex items-center justify-center space-x-2 rounded-xl bg-gray-900 text-white px-3 py-2.5 text-xs font-semibold hover:bg-gray-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white"
                      >
                        <VideoIcon size={13} />
        ...
        {selectedExam && activeCategory === 'pyqs' && (
          <div>
              ...
              <div className="grid gap-3 sm:grid-cols-4">
                <div className="relative sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-gray-50/30 pl-10 pr-4 py-2 text-sm outline-none focus:border-blue-500 focus:bg-white dark:border-slate-800 dark:bg-slate-950/30 dark:focus:border-blue-400"
                  />
                </div>
                <div>
                  <select
                    value={selectedSubject}
                    onChange={(e) => setSelectedSubject(e.target.value)}
                    className="w-full appearance-none rounded-xl border border-gray-200 bg-gray-50/30 px-3.5 py-2 text-sm outline-none focus:border-blue-500 focus:bg-white dark:border-slate-800 dark:bg-slate-950/30"
                  >
                    {availableSubjects.map((subject) => (
            ...
            {filteredPyqs.length === 0 ? (
              <div className="text-center py-12 rounded-2xl border border-dashed border-gray-200 dark:border-slate-800">
                <p className="text-sm text-gray-400 dark:text-slate-500">No PYQ booklets found matching your filters.</p>
              </div>
            ) : (
              <div className="overflow-hidden rounded-2xl border border-gray-150 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="border-b border-gray-100 bg-gray-50/60 font-mono text-[10px] uppercase tracking-wider text-gray-500 dark:border-slate-800 dark:bg-slate-950/40">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                      {filteredPyqs.map((pyq) => (
                        <tr key={pyq.id} className="hover:bg-gray-50/40 dark:hover:bg-slate-850/20 text-xs">
                          <td className="px-6 py-4">
                            <span className="font-semibold text-gray-900 dark:text-slate-200">{pyq.subject}</span>
                            <span className="block text-gray-400 dark:text-slate-500 text-[11px] mt-0.5">{pyq.chapter}</span>
                          </td>
                          <td className="px-6 py-4 font-mono font-bold text-gray-600 dark:text-slate-400">{pyq.year}</td>
                          <td className="px-6 py-4">
                            <span className={`inline-flex rounded-full px-2 py-0.5 text-[9px] font-semibold ${
                              pyq.difficulty === 'Easy' ? 'bg-green-50 text-green-700 dark:bg-green-950/40 dark:text-green-400' :
                              pyq.difficulty === 'Medium' ? 'bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400' :
        ...
        {selectedExam && activeCategory === 'sheets' && (
          <div>
              ...
              <div className="grid gap-4 md:grid-cols-12">
                <div className="relative md:col-span-8">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-gray-50/30 pl-10 pr-4 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:bg-white dark:border-slate-800 dark:bg-slate-950/30"
                  />
                </div>
                <div className="relative md:col-span-4">
                  <Filter size={14} className="absolute left-3.5 top-3.5 text-gray-400" />
                  <select
                    value={selectedSubject}
                    onChange={(e) => setSelectedSubject(e.target.value)}
                    className="w-full appearance-none rounded-xl border border-gray-200 bg-gray-50/30 pl-10 pr-4 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:bg-white dark:border-slate-800 dark:bg-slate-950/30"
                  >
                    {availableSubjects.map((subject) => (
                      <option key={subject} value={subject}>{subject} Only</option>
                    ))}
            ...
            {filteredSheets.length === 0 ? (
              <div className="text-center py-12 rounded-2xl border border-dashed border-gray-200 dark:border-slate-800">
                <p className="text-sm text-gray-400 dark:text-slate-500">No practice drills found matching your filters.</p>
              </div>
            ) : (
              <div className="grid gap-5 sm:grid-cols-2">
                {filteredSheets.map((sheet) => (
                  <div key={sheet.id} className="group rounded-2xl border border-gray-150 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    <div className="flex items-start justify-between">
                    ...
                    <h4 className="mt-4 text-sm font-bold text-gray-900 dark:text-white">{sheet.title}</h4>
                    <p className="mt-1 text-xs text-gray-500 dark:text-slate-400 leading-relaxed">{sheet.description}</p>
                    
                    <div className="mt-5 flex items-center justify-between border-t border-gray-50 pt-4 dark:border-slate-800">
                      <span className="font-mono text-[10px] text-gray-400 dark:text-slate-500">File size: {sheet.fileSize}</span>
                      <div className="flex space-x-2">
                        <button
        ...
        {selectedExam && activeCategory === 'doubts' && (
          <div>
            <div className="flex items-center justify-between border-b border-gray-100 pb-6 mb-8 dark:border-slate-800">
              <button onClick={handleBackToCategories} className="inline-flex items-center space-x-1 font-semibold text-xs text-gray-500 hover:text-blue-500">
                <ArrowLeft size={12} />
                <span>Back to Categories</span>
              </button>
            ...
            <div className="grid gap-10 lg:grid-cols-12">
              ...
              <div className="lg:col-span-7">
                <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                  ...
                  {doubtSubmitted && (
                    <div className="mb-6 flex items-center space-x-2.5 rounded-xl bg-green-50 px-4 py-3 text-xs text-green-800 border border-green-150 dark:bg-green-950/50 dark:text-green-300 dark:border-green-900/40 animate-fade-in">
                  ...
                  <form onSubmit={handleDoubtSubmit} className="space-y-4">
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div>
                        <label htmlFor="student-name" className="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider">
                          Your Name
                        </label>
                        <input
                          type="text"
                          ...
                          className="mt-1.5 block w-full rounded-xl border border-gray-200 bg-gray-50/40 px-3 py-2 text-xs outline-none focus:border-blue-500 focus:bg-white dark:border-slate-800 dark:bg-slate-950/40"
                          placeholder="e.g. Siddharth"
                        />
                      </div>
                      <div>
                        <label htmlFor="student-email" className="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider">
                          Your Email
                        </label>
                        <input
                          type="email"
                    ...
                    <div>
                      <label htmlFor="doubt-subject" className="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider">
                    ...
                    <div>
                      <label htmlFor="doubt-question" className="block text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider">
                    ...
                    <div>
                      ...
                      <div className="mt-1.5 flex items-center space-x-3">
                        <input
                          ...
                          className="block w-full rounded-xl border border-gray-200 bg-gray-50/20 px-3 py-2 text-xs text-gray-400"
                        />
                        <button
                          type="button"
                          onClick={() => setDoubtForm({ ...doubtForm, attachmentName: 'doubt-concept-diagram.png' })}
                          className="flex-shrink-0 rounded-xl bg-gray-50 border border-gray-200 px-3 py-2 text-[11px] font-semibold text-gray-600 hover:bg-gray-100 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-300"
                        >
                          Select File
                        </button>
                      </div>
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        className="w-full inline-flex items-center justify-center space-x-1.5 rounded-xl bg-blue-600 py-2.5 text-xs font-semibold text-white hover:bg-blue-700"
                ...
                <div className="space-y-3">
                  {faqs.map((faq) => {
                    ...
                    return (
                      <div
                        key={faq.id}
                        className="rounded-xl border border-gray-100 bg-white overflow-hidden dark:border-slate-800 dark:bg-slate-900"
                      >
                        <button
                          onClick={() => setExpandedFaqId(isExpanded ? null : faq.id)}
                          className="w-full flex items-center justify-between px-4 py-3.5 text-left text-xs font-bold text-gray-800 hover:bg-gray-50/50 dark:text-slate-200 dark:hover:bg-slate-850/50"
                        >
                          <span>{faq.question}</span>
                          {isExpanded ? <ChevronUp size={14} className="text-gray-400" /> : <ChevronDown size={14} className="text-gray-400" />}
                        </button>
                        {isExpanded && (
                          <div className="border-t border-gray-100/60 px-4 py-3 text-xs leading-relaxed text-gray-500 dark:border-slate-800 dark:text-slate-400">
                            {faq.answer}
                          </div>
                        )}
                      </div>
        ...
        {selectedExam && activeCategory === 'resources' && (
          <div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-gray-100 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
      ...
      {activeVideoModal && (
        <div className="fixed inset-0 z-55 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
          <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-slate-900 border border-gray-100 dark:border-slate-800">
            <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4 dark:border-slate-800">
              <div>
                <span className="font-mono text-[9px] uppercase font-bold text-blue-600 dark:text-blue-400">{activeVideoModal.subject} • {activeVideoModal.chapter}</span>
                <h3 className="text-sm font-bold text-gray-900 dark:text-white">{activeVideoModal.title}</h3>
              </div>
              <button
            ...
            <div className="aspect-video w-full bg-slate-950 flex flex-col items-center justify-center p-4 text-center">
              ...
              <div className="mt-5 flex space-x-3">
                <button
                  ...
                  className="inline-flex items-center space-x-1.5 rounded-lg bg-white px-3 py-1.5 font-semibold text-[11px] text-gray-900 hover:bg-gray-100"
                >
      ...
      {activePdfViewer && (
        <div className="fixed inset-0 z-55 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
          <div className="relative w-full max-w-3xl overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-slate-900 border border-gray-100 dark:border-slate-800">
            <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4 dark:border-slate-800">
              <div>
                <span className="font-mono text-[9px] uppercase font-bold text-blue-600 dark:text-blue-400">Interactive Document Viewer</span>
                <h3 className="text-sm font-bold text-gray-900 dark:text-white">{activePdfViewer.title}</h3>
              </div>
              <button
            ...
            <div className="max-h-[60vh] overflow-y-auto p-8 bg-gray-50 dark:bg-slate-950 font-sans text-gray-800 dark:text-slate-300">
              <div className="mx-auto max-w-2xl bg-white p-10 shadow-md dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded">
                ...
                <div className="space-y-4 text-xs leading-relaxed">
                  <p className="font-semibold text-sm text-gray-900 dark:text-white">I. FOUNDATIONAL THEOREMS & BOUNDARIES</p>
                  <p>
                  ...
                  <div className="my-4 bg-gray-50 p-3 text-center font-mono text-[11px] rounded dark:bg-slate-950 border border-gray-100 dark:border-slate-800">
                    ∮_S E • dA = Q_encl / ε_0
                  </div>
                  <p className="font-semibold text-sm text-gray-900 dark:text-white">II. COMPREHENSIVE PROOFS & INTEGRATIONS</p>
                  <p>
                  ...
                  <ul className="list-disc list-inside space-y-1.5 text-gray-600 dark:text-slate-400">
                  ...
                  <p className="font-semibold text-sm text-gray-900 dark:text-white">III. KEY COMPETITIVE BLOCKERS & DERIVATIONS</p>
                  <p>
                ...
                <div className="mt-8 border-t border-gray-100 pt-6 text-center text-[10px] font-mono text-gray-400 dark:border-slate-800">
                  --- End of Document Preview ---
                </div>
              </div>
            </div>

            <div className="p-4 border-t border-gray-100 bg-gray-50 flex justify-between items-center dark:border-slate-800 dark:bg-slate-900">
              <span className="text-[10px] text-gray-400 dark:text-slate-500">Secure Client-Side Sandbox Preview</span>
              <button
