...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="w-full bg-[#F7F3EC] dark:bg-[#1A1817] pt-8 pb-6 transition-colors duration-300">
      {/* Floating Lightweight Card Container */}
      <div className="mx-auto w-[92%] max-w-7xl rounded-[24px] bg-[#4A0E1B] dark:bg-[#22201F] px-6 py-7 md:px-10 md:py-8 shadow-[0_8px_30px_rgba(74,14,27,0.15)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.15)] border border-[#7C2532]/30 dark:border-[#C9A13B]/8 relative transition-all duration-300">
