...
const BottomLink = ({ onClick, children }: BottomLinkProps) => {
  return (
    <button
      onClick={onClick}
      className="group relative flex items-center text-[12px] md:text-[13px] font-medium text-[#22201F]/50 dark:text-[#F7F3EC]/50 hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] dark:hover:text-[#C9A13B] transition-colors duration-200 ease-out focus:outline-none"
    >
...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="w-full bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#22201F] pt-8 pb-6 transition-colors duration-300">
      {/* Floating Lightweight Card Container */}
      <div className="mx-auto w-[92%] max-w-7xl rounded-[24px] bg-white dark:bg-[#22201F] dark:bg-[#4A0E1B]/12 px-6 py-7 md:px-10 md:py-8 shadow-[0_8px_30px_rgba(74,14,27,0.02)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.15)] border border-[#D9C2A2]/25 dark:border-[#C9A13B]/8 relative transition-all duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          ...
          <div className="flex flex-col space-y-1">
            <h4 className="text-[18px] font-semibold tracking-tight text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F7F3EC] font-display">
              Prof. Ajesh Joe
            </h4>
          ...
          <div className="flex flex-col space-y-1 text-left md:text-right items-start md:items-end text-[14px] font-normal text-[#22201F]/80 dark:text-[#F7F3EC]/80">
            ...
            <a
              ...
              className="group relative inline-flex items-center text-[14px] font-normal text-[#22201F]/80 dark:text-[#F7F3EC]/80 hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] dark:hover:text-[#C9A13B] transition-colors duration-200 ease-out focus:outline-none"
            >
              <span className="transform transition-transform duration-200 ease-out group-hover:translate-x-[2px] relative flex flex-col pb-0.5">
