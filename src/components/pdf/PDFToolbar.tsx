  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1">
        ...
        <span className="dash-mono text-[10px] text-[#22201F] dark:text-[#F6F2EA]/60">/ {numPages || '—'}</span>
            ...
            <div className="absolute right-0 top-full z-50 mt-1 w-36 overflow-hidden rounded-2xl border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] p-1 shadow-soft-lg">
              {ZOOM_PRESETS.map(z => (
                <button
                  ...
                  className={`flex w-full items-center rounded-xl px-3 py-1.5 text-xs font-semibold transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] ${Math.abs(zoom - z) < 0.01 && zoomMode === 'custom' ? 'bg-[#4A0E1B]/8 text-[#4A0E1B]' : 'text-[#22201F] dark:text-[#F6F2EA]/80'}`}
                >
                  {Math.round(z * 100)}%
                </button>
              ))}
              ...
              <button
                ...
                className={`flex w-full items-center rounded-xl px-3 py-1.5 text-xs font-semibold transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] ${zoomMode === 'fitPage' ? 'bg-[#4A0E1B]/8 text-[#4A0E1B]' : 'text-[#22201F] dark:text-[#F6F2EA]/80'}`}
              >
                Fit Page
              </button>
            </div>
  ...
  return (
    <div className="flex items-center gap-2 rounded-2xl border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] p-2 shadow-soft-lg">
      ...
      <input
        ...
        className="w-52 bg-transparent text-sm text-[#22201F] dark:text-[#F6F2EA] placeholder:text-[#22201F] dark:text-[#F6F2EA]/30 outline-none"
        aria-label="Search query"
      />
      <label className="flex cursor-pointer items-center gap-1 text-[10px] font-bold uppercase tracking-[0.1em] text-[#22201F] dark:text-[#F6F2EA]/60">
        <input
          type="checkbox"
      ...
      <button
        onClick={onClose}
        className="flex h-6 w-6 items-center justify-center rounded-lg text-[#22201F] dark:text-[#F6F2EA]/60 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] hover:text-[#4A0E1B]"
