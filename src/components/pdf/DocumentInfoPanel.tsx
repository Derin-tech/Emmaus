    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex h-6 w-6 items-center justify-center rounded-lg text-[#22201F]/60 transition-colors hover:bg-[#D9C2A2]/20 hover:text-[#22201F] dark:text-[#F6F2EA]"
            ...
            {bookmarks.sort((a, b) => a.page - b.page).map(bm => (
              ...
              >
                ...
                <button
                  ...
                  className="ml-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-lg text-[#22201F]/60 opacity-0 transition-all hover:bg-[#4A0E1B]/8 hover:text-[#4A0E1B] dark:hover:text-[#F4E7E5] dark:text-[#F4E7E5] group-hover:opacity-100"
