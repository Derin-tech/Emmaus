    ...
    return (
      <ModalShell onClose={onClose}>
        <div className="flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center">
          ...
          <p className="max-w-xs text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">{urlError}</p>
          <button
            onClick={onClose}
    ...
    return (
      <>
        ...
        <div className="flex flex-1 items-center justify-center gap-3 bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817]">
          ...
          <p className="dash-root text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">Resolving document…</p>
        </div>
      </>
    );
  }
