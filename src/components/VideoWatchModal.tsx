        ...
        <div className="flex shrink-0 items-center justify-between gap-4 border-b border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] px-4 py-3 sm:px-5">
          ...
          <div className="flex shrink-0 items-center gap-1">
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg text-[#22201F]/80 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] lg:hidden"
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg text-[#22201F]/80 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA]"
            ...
            <div className="flex-1 space-y-5 p-4 sm:p-6">
              ...
              <div>
                ...
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#F7F3EC] dark:bg-[#1A1817] px-2.5 py-1 text-[10px] font-bold text-[#22201F]/60 border border-[#D9C2A2]/20">
                    <BookOpen size={10} />
                    {video.subject}
                  </span>
                  {video.duration && (
