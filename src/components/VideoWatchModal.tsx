...
const MICRO = 'text-[10px] font-bold uppercase tracking-[0.14em] text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60';
...
function VideoThumbnail({
  ...
  if (!videoId) {
    return (
      <div className={`flex items-center justify-center bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] ${className}`}>
        <Play size={20} className="text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/40" />
      </div>
    );
  }
...
export function VideoWatchModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-0 sm:p-4 dash-root">
      ...
      {/* Modal shell */}
      <div
        className={`relative flex h-full w-full flex-col overflow-hidden bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] transition-all duration-300 sm:rounded-card sm:shadow-[0_20px_60px_rgba(74,14,27,0.12)] border border-[#D9C2A2]/45 ${
          theater
      ...
      >
        {/* ── Header ─────────────────────────────────────────────────────── */}
        <div className="flex shrink-0 items-center justify-between gap-4 border-b border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-4 py-3 sm:px-5">
          ...
          <div className="flex shrink-0 items-center gap-1">
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/80 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] lg:hidden"
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/80 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]"
        ...
        <div className="flex min-h-0 flex-1 overflow-hidden">
            ...
            <div className="relative bg-[#0f0f0f]">
              {videoId ? (
                ...
                <div className="aspect-video w-full flex flex-col items-center justify-center bg-[#0f0f0f] text-center p-6">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]/10">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0f0f0f]/90 text-white p-6">
                  ...
                  <div className="mt-6 flex gap-3">
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-btn border border-[#D9C2A2]/40 bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]/10 px-4 py-2 text-xs font-bold text-white hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]/20 transition-colors"
                    >
                      Stay here
                    </button>
                    <button
            ...
            <div className="flex-1 space-y-5 p-4 sm:p-6">
              ...
              <div>
                ...
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] px-2.5 py-1 text-[10px] font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60 border border-[#D9C2A2]/20">
                    <BookOpen size={10} />
                    {video.subject}
                  </span>
                  {video.duration && (
                ...
                <h2 className="dash-serif text-xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] leading-snug sm:text-2xl">
                  {video.title}
                </h2>
              ...
              {video.description && (
                <PremiumCard padding="medium" accentLine>
                  ...
                  <p className="text-sm leading-relaxed text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/80">{video.description}</p>
              ...
              <div className="flex items-center gap-3 border-t border-[#D9C2A2]/20 pt-4">
                <button
                  onClick={goPrev}
                  disabled={!prevVideo}
                  className="flex-1 inline-flex items-center gap-2 rounded-full border border-[#D9C2A2]/40 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-5 py-2.5 text-xs font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-all hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] disabled:pointer-events-none disabled:opacity-40 hover:-translate-y-0.5 shadow-sm"
                >
                  <ChevronLeft size={15} />
                ...
                <button
                  onClick={goNext}
                  disabled={!nextVideo}
                  className="flex-1 inline-flex items-center justify-end gap-2 rounded-full border border-[#D9C2A2]/40 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-5 py-2.5 text-xs font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-all hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] disabled:pointer-events-none disabled:opacity-40 hover:-translate-y-0.5 shadow-sm"
                >
          ...
          {/* ── Sidebar playlist ─────────────────────────────────────────── */}
          <aside
            className={`shrink-0 overflow-y-auto border-l border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] transition-all duration-300 ${
              sidebarOpen ? 'w-72 xl:w-80' : 'w-0 overflow-hidden border-0'
            }`}
          >
            <div className="sticky top-0 z-10 border-b border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-4 py-3">
              <p className={MICRO}>Playlist</p>
              <p className="mt-0.5 text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">
                {examLabel} · {video.subject}
              </p>
              <p className="text-xs text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">
            ...
            <div className="divide-y divide-[#D9C2A2]/20 p-2">
                ...
                return (
                  <button
                    ...
                    className={`group flex w-full items-start gap-3 rounded-xl px-2.5 py-3 text-left transition-colors ${
                      isActive
                        ? 'bg-[#4A0E1B]/8'
                        : 'hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]/50'
                    }`}
                  >
                    {/* Thumbnail / index */}
                    <div className="relative h-14 w-24 shrink-0 overflow-hidden rounded-lg bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]">
                      {itemId ? (
                        <PlaylistThumbnail videoId={itemId} alt={item.title} />
                      ) : (
                        <div className="flex h-full items-center justify-center">
                          <span className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/40">
                            {idx + 1}
                          </span>
                        </div>
                      )}
                    ...
                    <div className="min-w-0 flex-1">
                      <p
                        className={`line-clamp-2 text-xs font-semibold leading-snug ${
                          isActive ? 'text-[#4A0E1B]' : 'text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] group-hover:text-[#4A0E1B]'
                        } transition-colors`}
                      >
                        {item.title}
                      </p>
                      <p className="mt-1 text-[10px] text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">{item.chapter}</p>
                      {item.duration && (
                        <p className="dash-mono mt-1 text-[10px] tabular-nums text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/40">
                          {item.duration}
                        </p>
                      )}
                    </div>
              ...
              {playlist.length === 0 && (
                <p className="px-4 py-8 text-center text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">
