...
const CARD =
  'rounded-2xl border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#383330] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] shadow-[0_1px_2px_rgba(34,32,31,0.04),0_18px_36px_-26px_rgba(34,32,31,0.35)]';
const MICRO = 'text-[10px] font-bold uppercase tracking-[0.14em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]';
...
export default function AboutPage({ onNavigate }: AboutPageProps) {
  return (
    <div className="dash-root min-h-screen bg-[#F6F2EA] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 sm:py-14">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-[#4A0E1B] p-7 text-white shadow-[0_22px_44px_-24px_rgba(74,14,27,0.75)] sm:p-10">
          ...
          <div className="relative flex flex-col items-center gap-7 text-center md:flex-row md:items-center md:gap-9 md:text-left">
            ...
            <div className="relative shrink-0">
              ...
              <span className="absolute -bottom-2 -right-2 flex h-10 w-10 items-center justify-center rounded-2xl border-4 border-[#4A0E1B] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] text-[#4A0E1B] dark:text-[#F4E7E5]">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-5 flex flex-wrap justify-center gap-2 md:justify-start">
                {[
                  ...
                  <span
                    key={i}
                    className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]/10 px-3 py-1.5 text-[11px] font-semibold text-white/90"
                  >
        ...
        <div className="relative z-10 -mt-6 grid grid-cols-2 gap-4 sm:-mt-8 lg:grid-cols-4">
          {FACTS.map((f, i) => (
            <div key={i} className={`${CARD} p-5`}>
              <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]">
                {f.icon}
              </span>
              <p className="dash-serif mt-3 text-3xl font-semibold leading-none text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{f.value}</p>
        ...
        <section className="mt-12">
          ...
          <h2 className="dash-serif mt-1 text-2xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">A scholar devoted to teaching</h2>
          <div className={`${CARD} mt-4 p-6 sm:p-8`}>
            <div className="space-y-4 text-sm leading-relaxed text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#A89F91]">
              <p>
        ...
        <section className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <div className={`${CARD} p-6`}>
            ...
            <h3 className="dash-serif mt-1 text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Fields of focus</h3>
            <ul className="mt-5 space-y-3.5">
              {INTERESTS.map((it, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#380A14] text-[#4A0E1B] dark:text-[#F4E7E5]">
                    {it.icon}
                  </span>
          ...
          <div className={`${CARD} p-6`}>
            ...
            <h3 className="dash-serif mt-1 text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Career timeline</h3>
            <ul className="mt-6 space-y-6 border-l border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#383330] pl-5">
              {EXPERIENCE.map((exp, i) => (
                <li key={i} className="relative">
                  ...
                  <span className="mt-1 block text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{exp.title}</span>
                  <span className="mt-0.5 block text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{exp.place}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex shrink-0 flex-wrap gap-2.5">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-white/20 px-4 py-2.5 text-xs font-bold tracking-wide text-white transition-colors hover:bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]/10"
              >
                Contact office
              </button>
            </div>
