        ...
        <div className="flex flex-col items-center gap-8 border-b border-gray-100 pb-12  md:flex-row md:items-start">
          ...
          <div className="relative h-44 w-44 flex-shrink-0">
            ...
            <div className="relative flex h-44 w-44 items-center justify-center rounded-lg border-2 border-[#E5E5EA] bg-[#FFFFFF] shadow-none">
              <svg viewBox="0 0 100 100" className="h-28 w-28 text-gray-600" fill="currentColor">
          ...
          <div className="flex flex-col space-y-4 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center gap-y-2 gap-x-4 text-[10px] font-black uppercase tracking-wider text-gray-600 md:justify-start">
              ...
              <ul className="space-y-4 border-l-2 border-[#E5E5EA] ml-2 pl-4">
                {[
                  ...
                  <li key={i} className="relative">
                    ...
                    <span className="mt-1 block font-bold text-gray-900">{exp.title}</span>
                    <span className="mt-0.5 block text-xs text-gray-600">{exp.place}</span>
                  </li>
                ))}
              </ul>
            </div>
