  ...
  return (
    <section className="bg-[#111112] py-16 md:py-20 text-white">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Profile Card Header */}
        <div className="flex flex-col items-center gap-8 border-b border-gray-800 pb-12  md:flex-row md:items-start">
          ...
          <div className="relative h-44 w-44 flex-shrink-0">
            ...
            <div className="relative flex h-44 w-44 items-center justify-center rounded-lg border-2 border-gray-800 bg-[#1c1c1e] shadow-none">
              <svg viewBox="0 0 100 100" className="h-28 w-28 text-gray-400" fill="currentColor">
            ...
            <div className="absolute -bottom-2 -right-2 flex h-10 w-10 items-center justify-center bg-[#F1E194] border-2 border-[#F1E194] text-[#F1E194] shadow-[inset_0_-2px_0_rgba(0,0,0,0.5)]">
          ...
          <div className="flex flex-col space-y-4 text-center md:text-left">
            <div>
              ...
              <p className="mt-2 font-sans text-[10px] uppercase tracking-[0.2em] font-black text-[#F1E194]">
                Senior Professor of Chemistry
              </p>
            </div>

            <div className="flex flex-wrap justify-center gap-y-2 gap-x-4 text-[10px] font-black uppercase tracking-wider text-gray-400 md:justify-start">
              <span className="flex items-center gap-1.5 border-2 border-gray-800 bg-[#1c1c1e] px-2 py-1">
                <Building size={12} className="text-[#F1E194]" />
                <span>Dept. of Chemistry</span>
              </span>
              <span className="flex items-center gap-1.5 border-2 border-gray-800 bg-[#1c1c1e] px-2 py-1">
                <MapPin size={12} className="text-[#F1E194]" />
        ...
        <div className="mt-12 space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="border-l-4 border-[#5B0E14] bg-[#1c1c1e] p-5 shadow-[inset_0_-2px_0_rgba(0,0,0,0.3)]">
              <p className="italic text-sm leading-relaxed text-gray-400">
          ...
          <div className="grid gap-8 md:grid-cols-2">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2.5">
                    <div className="mt-1 flex h-4 w-4 flex-shrink-0 items-center justify-center border-2 border-gray-800 bg-[#1c1c1e] text-[#F1E194]">
                      <BookOpen size={10} />
                    </div>
                    <span className="text-sm font-bold text-gray-400">{interest}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-4 border-l-2 border-gray-800 ml-2 pl-4">
                {[
                  {
                    year: '2015 - Present',
                  ...
                  <li key={i} className="relative">
                    <div className="absolute -left-[23px] top-1.5 h-3 w-3 border-2 border-gray-800 bg-[#F1E194]" />
                    <span className="block font-sans text-[9px] uppercase tracking-wider font-black text-[#F1E194]">{exp.year}</span>
                    <span className="mt-1 block font-bold text-white">{exp.title}</span>
                    <span className="mt-0.5 block text-xs text-gray-400">{exp.place}</span>
                  </li>
                ))}
              </ul>
            </div>
