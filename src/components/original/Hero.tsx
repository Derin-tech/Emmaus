...
export default function Hero({ onGetStarted, onNavigate }: HeroProps) {
  return (
    <section className="relative overflow-hidden bg-[#111112] py-16 md:py-24">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col space-y-6 lg:col-span-7">
            ...
            <div className="flex items-center space-x-2">
              <span className="flex items-center space-x-2 bg-[#1c1c1e] border-2 border-gray-800 px-3 py-1 font-sans text-[9px] uppercase tracking-[0.2em] font-black text-[#F1E194]">
                <span className="h-1.5 w-1.5 bg-[#F1E194] animate-pulse" />
                <span>NON-COMMERCIAL DIGITAL LIBRARY</span>
              </span>
            </div>

            <h1 className="text-4xl font-display font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl leading-none">
              Free Learning <br />
              <span className="text-[#F1E194]">Resources</span>
            </h1>
            ...
            <div className="pt-4">
              <button
                ...
                className="group flex items-center space-x-2 bg-[#5B0E14] px-6 py-3.5 text-sm font-bold text-white uppercase tracking-wider border-2 border-red-950 shadow-[inset_0_-4px_0_rgba(0,0,0,0.5)] active:shadow-[inset_0_0px_0_rgba(0,0,0,0.5)] active:translate-y-1 transition-all"
            ...
            <div className="grid grid-cols-3 gap-6 border-t-2 border-gray-800 pt-8 mt-8">
              <div>
                <p className="text-[9px] uppercase tracking-[0.2em] font-black text-gray-500">Curriculums</p>
                <p className="mt-1 text-lg font-display text-white">5 Exam Focuses</p>
              </div>
              <div>
                <p className="text-[9px] uppercase tracking-[0.2em] font-black text-gray-500">Material</p>
                <p className="mt-1 text-lg font-display text-white">100% Free PDFs</p>
              </div>
              <div>
                <p className="text-[9px] uppercase tracking-[0.2em] font-black text-gray-500">Guidance</p>
                <p className="mt-1 text-lg font-display text-white">Doubt Clarification</p>
              </div>
            </div>
          ...
          <div className="flex justify-center lg:col-span-5">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative overflow-hidden border-2 border-gray-800 bg-[#1c1c1e] p-6 shadow-none">
                ...
                <div className="flex items-center justify-between border-b-2 border-gray-800 pb-4">
                  ...
                  <span className="text-[9px] uppercase tracking-[0.2em] font-black text-gray-500">
