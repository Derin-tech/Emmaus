        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="flex flex-col space-y-6 lg:col-span-7">
            ...
            <div className="flex items-center space-x-2">
              <span className="flex items-center space-x-2 bg-white border border-[#D9C2A2]/40 px-3 py-1 font-sans text-[9px] uppercase tracking-[0.2em] font-bold text-[#C9A13B]">
                <span className="h-1.5 w-1.5 bg-[#C9A13B] rounded-full animate-pulse" />
                <span>NON-COMMERCIAL DIGITAL LIBRARY</span>
              </span>
            </div>

            <h1 className="text-4xl font-serif font-extrabold tracking-tight text-[#22201F] sm:text-5xl md:text-6xl leading-none">
              Free Learning <br />
              <span className="text-[#4A0E1B]">Resources</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-6 border-t border-[#D9C2A2]/30 pt-8 mt-8">
              <div>
                ...
                <p className="mt-1 text-lg font-semibold font-serif text-[#22201F]">5 Exam Focuses</p>
              </div>
              <div>
                <p className="text-[9px] uppercase tracking-[0.2em] font-bold text-[#22201F]/60">Material</p>
                <p className="mt-1 text-lg font-semibold font-serif text-[#22201F]">100% Free PDFs</p>
              </div>
              <div>
                <p className="text-[9px] uppercase tracking-[0.2em] font-bold text-[#22201F]/60">Guidance</p>
                <p className="mt-1 text-lg font-semibold font-serif text-[#22201F]">Doubt Clarification</p>
              </div>
            </div>
          ...
          <div className="flex justify-center lg:col-span-5">
            <div className="relative w-full max-w-md">
              ...
              <PremiumCard padding="large" accentLine className="relative overflow-hidden shadow-[0_15px_40px_rgba(74,14,27,0.06)]">
                ...
                <div className="my-8 flex h-48 items-center justify-center rounded-xl bg-[#F7F3EC] p-4">
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between rounded-xl border border-[#D9C2A2]/20 bg-[#F7F3EC]/50 p-2.5">
                    <div className="flex items-center space-x-2.5">
                      <div className="flex h-7 w-7 items-center justify-center rounded bg-[#4A0E1B]/8 text-[#4A0E1B]">
                        <BookOpen size={14} />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-xs font-semibold text-[#22201F]">Quantum Wave Mechanics</span>
