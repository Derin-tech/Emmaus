    ...
    <section className="bg-[#F7F3EC] py-16 md:py-20 text-[#22201F]">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-serif font-extrabold tracking-tight text-[#22201F]">
            Contact Office
          </h2>
        ...
        <div className="mt-12 grid gap-10 md:grid-cols-12">
          ...
          <div className="space-y-6 md:col-span-5">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-[#22201F] mt-1 select-all">
            ...
            <div className="border-l-4 border-[#4A0E1B] bg-white p-4 rounded-r-xl border-y border-r border-[#D9C2A2]/30 shadow-soft-sm">
              <p className="text-[11px] leading-relaxed text-[#22201F]/60">
                <strong className="text-[#22201F]">Please Note:</strong> This office does not accept commercial marketing pitches, EdTech partnership proposals, or coaching institute sponsorships. All educational content here is strictly non-commercial.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-7">
            <PremiumCard padding="large" accentLine>
              ...
              <h3 className="text-lg font-serif font-bold text-[#22201F] mb-6">
                Send a Message
              </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-2 block w-full border border-[#D9C2A2]/40 bg-white px-3.5 py-3 text-sm text-[#22201F] rounded-input outline-none transition focus:border-[#4A0E1B]/50 focus:ring-4 focus:ring-[#C9A13B]/10 placeholder:text-[#22201F]/30"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-2 block w-full border border-[#D9C2A2]/40 bg-white px-3.5 py-3 text-sm text-[#22201F] rounded-input outline-none transition focus:border-[#4A0E1B]/50 focus:ring-4 focus:ring-[#C9A13B]/10 placeholder:text-[#22201F]/30 resize-none"
