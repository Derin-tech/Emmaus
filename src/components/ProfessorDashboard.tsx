...
const INPUT =
  'w-full rounded-input border border-[#D9C2A2]/40 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-3.5 py-2.5 text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] placeholder:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/30 outline-none transition focus:border-[#4A0E1B]/50 focus:ring-4 focus:ring-[#C9A13B]/10';
const PRIMARY_BTN =
...
const GHOST_BTN =
  'inline-flex items-center justify-center gap-2 rounded-btn border border-[#D9C2A2]/40 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-4 py-2.5 text-xs font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-all hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:-translate-y-0.5 duration-200';
const ROW_BTN =
  'inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/80 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#4A0E1B]';
...
const MICRO = 'text-[10px] font-bold uppercase tracking-[0.14em] text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60';

const EXAM_STYLES: Record<string, { bg: string; text: string; dot: string }> = {
  'jee-main': { bg: 'bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A]', text: 'text-[#4A0E1B]', dot: 'bg-[#4A0E1B]' },
  'jee-advanced': { bg: 'bg-[#F4E2E5]', text: 'text-[#7C2532]', dot: 'bg-[#7C2532]' },
  neet: { bg: 'bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D]', text: 'text-[#8A6A16]', dot: 'bg-[#C9A13B]' },
  net: { bg: 'bg-[#ECE7E0]', text: 'text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]', dot: 'bg-[#22201F]' },
...
const ANN_CAT: Record<AnnouncementCategory, { label: string; cls: string }> = {
  ...
  resource: { label: 'Resource', cls: 'bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]' },
...
function SubjectBadge({ subject }: { subject: string }) {
  ...
  if (!s) return <span className="text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{subject}</span>;
  return (
...
function DifficultyChip({ level }: { level: 'Easy' | 'Medium' | 'Hard' }) {
  const map = {
    Easy: 'bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]',
...
function StatCard({
  ...
  return (
    <PremiumCard padding="medium">
      ...
      <p className="mt-4 text-3xl font-bold leading-none tabular-nums text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{value}</p>
  ...
  return (
    <div>
      <div className="mb-1.5 flex items-baseline justify-between gap-3">
        ...
        <span className="dash-mono shrink-0 text-xs tabular-nums text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{sub}</span>
      </div>
...
function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-[#E0D5C2] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-6 py-14 text-center">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]">{icon}</div>
      <h4 className="dash-serif mt-4 text-base font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{title}</h4>
      <p className="mt-1 max-w-sm text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{message}</p>
...
function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className={`relative w-full ${wide ? 'max-w-2xl' : 'max-w-lg'} overflow-hidden rounded-modal border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] shadow-soft-xl`}>
        <div className="flex items-start justify-between gap-4 border-b border-[#D9C2A2]/20 px-6 py-5">
          <div>
            <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{title}</h3>
            {subtitle && <p className="mt-0.5 text-xs text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">{subtitle}</p>}
          </div>
          <button onClick={onClose} className="rounded-lg p-1.5 text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60 transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">
            <X size={18} />
          </button>
        </div>
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="block">
      <span className="mb-1.5 block text-[11px] font-bold uppercase tracking-[0.1em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{label}</span>
      {children}
    </div>
  );
}
...
function YouTubeLinkField({ value, onChange }: { value: string; onChange: (v: string) => void }) {
  ...
  return (
    <div className="block">
      <span className="mb-1.5 flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.1em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
        YouTube URL
      ...
      <div className="relative">
        <input
          type="url"
          className={`w-full rounded-xl border bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-3.5 py-2.5 pr-10 text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] placeholder:text-[#B3A996] outline-none transition ${
            showError
              ? 'border-[#B23B2E]/60 focus:border-[#B23B2E]/80 focus:ring-4 focus:ring-[#B23B2E]/10'
              : showOk
              ? 'border-[#8A6A16]/60 focus:border-[#8A6A16]/80 focus:ring-4 focus:ring-[#8A6A16]/10 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]'
              : 'border-[#E3D8C5] focus:border-[#4A0E1B]/50 focus:bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] focus:ring-4 focus:ring-[#4A0E1B]/10'
          }`}
          required
          value={value}
          onChange={(e) => {
      ...
      {showOk && thumbSrc && !thumbError && (
        <div className="mt-3 flex items-start gap-3 rounded-xl border border-[#F7EFD9] bg-[#FBF6EA] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] p-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 font-mono text-[10px] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] break-all">
              Video ID: <span className="text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] font-semibold">{videoId}</span>
            </p>
            <p className="mt-1 text-[10px] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
...
export default function ProfessorDashboard({
  ...
  return (
    <div className="dash-root min-h-[85vh] bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <header className="mb-7 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="dash-serif mt-1 text-3xl font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] sm:text-[2rem]">{pageTitle[activeTab]}</h1>
            <p className="mt-1 flex items-center gap-1.5 text-sm text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">
          ...
          <div className="relative">
            ...
            {quickAddOpen && (
              <>
                ...
                <div className="absolute right-0 z-50 mt-2 w-56 overflow-hidden rounded-2xl border border-[#D9C2A2]/30 bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] p-1.5 shadow-soft-lg">
                  {quickAdd.map((item) => (
                    <button
                      key={item.label}
                      onClick={() => {
                      ...
                      className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA] transition-colors hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817]"
                    >
        ...
        <div className="grid gap-7 lg:grid-cols-12">
          ...
          <aside className="lg:col-span-3">
            <div className="lg:sticky lg:top-24">
              <PremiumCard padding="small">
                ...
                <div className="mb-3 flex items-center gap-3 rounded-xl bg-gradient-to-br from-[#4A0E1B]/8 to-[#C9A13B]/8 border border-[#D9C2A2]/20 p-3">
                  ...
                  <div className="min-w-0">
                    <h3 className="truncate text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{profile.name}</h3>
                    <span className="text-[11px] font-medium text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60">{profile.role}</span>
                  </div>
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={`group relative flex w-full items-center gap-3 rounded-[12px] px-3.5 py-2.5 text-sm font-semibold transition-all duration-200 ${
                          active ? 'bg-[#4A0E1B]/8 text-[#4A0E1B]' : 'text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/80 hover:bg-[#F7F3EC] dark:bg-[#1A1817] dark:bg-[#1A1817] dark:bg-[#1A1817] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]'
                        }`}
                      >
              ...
              <div className="mt-3 flex items-center gap-2 rounded-xl border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-3.5 py-3 text-[11px] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
          ...
          <main className="lg:col-span-9">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="relative overflow-hidden rounded-hero bg-gradient-to-r from-[#4A0E1B] to-[#7C2532] p-6 text-white shadow-soft-xl border border-[#D9C2A2]/20 sm:p-7">
                  ...
                  <div className="pointer-events-none absolute -bottom-14 right-24 h-36 w-36 rounded-full bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F]/10 blur-2xl" />
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  <PremiumCard padding="large" accentLine>
                    <div className="mb-5 flex items-center justify-between">
                      <div>
                        <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Most downloaded notes</h3>
                        <p className="text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">What students reach for most</p>
                      </div>
                      <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] text-[#4A0E1B]">
                        <TrendingUp size={17} />
                      </span>
                    </div>
                    {topNotes.length === 0 ? (
                      <p className="py-8 text-center text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">No notes yet.</p>
                    ) : (
                  ...
                  <PremiumCard padding="large" accentLine>
                    <div className="mb-5 flex items-center justify-between">
                      <div>
                        <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Library by exam</h3>
                        <p className="text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">How your content is spread</p>
                      </div>
                      <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  <PremiumCard padding="large" accentLine>
                    <div className="mb-4 flex items-center justify-between">
                      <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Needs your attention</h3>
                    ...
                    {pendingDoubtsCount === 0 ? (
                      <div className="flex flex-col items-center py-6 text-center">
                        <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] text-[#8A6A16]">
                          <Check size={20} />
                        </span>
                        <p className="mt-3 text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">You're all caught up</p>
                        <p className="text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Every student doubt has an answer.</p>
                      </div>
                    ) : (
                        ...
                        {doubts
                           ...
                           .map((d) => (
                             <button
                               ...
                               className="flex w-full items-start gap-3 rounded-xl border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] p-3 text-left transition-colors hover:border-[#E3D1CD] hover:bg-[#F8EEEC]"
                             >
                               <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] ring-1 ring-[#EAE1D2]">
                                 <User size={14} />
                               </span>
                               <span className="min-w-0 flex-1">
                                 <span className="flex items-center justify-between gap-2">
                                   <span className="truncate text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{d.name}</span>
                                   <span className="dash-mono shrink-0 text-[10px] text-[#A79A88]">{fmtDate(d.createdAt)}</span>
                                 </span>
                                 <span className="line-clamp-1 text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{d.question}</span>
                               </span>
                  ...
                  <PremiumCard padding="large" accentLine>
                    <h3 className="dash-serif mb-4 text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Recent uploads</h3>
                    {recentUploads.length === 0 ? (
                      <p className="py-8 text-center text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Nothing uploaded yet.</p>
                    ) : (
                      <div className="space-y-1">
                        {recentUploads.map((item, i) => (
                          <div key={i} className="flex items-center gap-3 border-b border-[#F2ECDF] dark:border-[#383330] dark:border-[#383330] dark:border-[#383330] py-2.5 last:border-0">
                            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] text-[#4A0E1B]">{typeIcon[item.type]}</span>
                            <div className="min-w-0 flex-1">
                              <p className="truncate text-sm font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{item.title}</p>
                              <p className="truncate text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{item.detail}</p>
                            </div>
                  ...
                  <Table head={['Exam & subject', 'Title & chapter', 'Downloads', '']}>
                    {notesFiltered.map((n) => (
                      <tr key={n.id} className="transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726]">
                        ...
                        <td className="px-5 py-3.5">
                          <span className="font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{n.title}</span>
                          <span className="mt-0.5 block text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{n.chapter}</span>
                        </td>
                        <td className="px-5 py-3.5">
                  ...
                  <Table head={['Exam & subject', 'Lecture & chapter', 'Duration', '']}>
                    {videosFiltered.map((v) => (
                      <tr key={v.id} className="transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726]">
                        ...
                        <td className="px-5 py-3.5">
                          <span className="font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{v.title}</span>
                          <span className="mt-0.5 block text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{v.chapter}</span>
                        </td>
                        <td className="px-5 py-3.5">
                  ...
                  <Table head={['Exam & subject', 'Chapter & year', 'Difficulty', '']}>
                    {pyqsFiltered.map((p) => (
                      <tr key={p.id} className="transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726]">
                        ...
                        <td className="px-5 py-3.5">
                          <span className="font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{p.chapter}</span>
                          <span className="dash-mono mt-0.5 block text-xs tabular-nums text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Year {p.year}</span>
                        </td>
                        <td className="px-5 py-3.5">
                  ...
                  <Table head={['Exam & subject', 'Title', 'Chapter', '']}>
                    {sheetsFiltered.map((s) => (
                      <tr key={s.id} className="transition-colors hover:bg-[#FBF7F0] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726] dark:bg-[#2A2726] dark:hover:bg-[#2A2726]">
                        ...
                        <td className="px-5 py-3.5 font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{s.title}</td>
                        <td className="px-5 py-3.5 text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{s.chapter}</td>
                        <td className="px-5 py-3.5">
                          <RowActions
            ...
            {activeTab === 'doubts' && (
              <div className="space-y-5">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="inline-flex rounded-xl border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] p-1">
                    {(['unanswered', 'answered', 'all'] as const).map((t) => {
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-lg px-3.5 py-1.5 text-xs font-bold capitalize transition-colors ${active ? 'bg-[#4A0E1B] text-white' : 'text-[#6E645A] hover:text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]'}`}
                        >
                      ...
                      <PremiumCard key={doubt.id} padding="medium" className={!doubt.isAnswered ? 'ring-1 ring-[#4A0E1B]/12' : ''}>
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-start gap-3">
                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] text-[#4A0E1B]">
                              <User size={16} />
                            </span>
                            <div>
                              <h4 className="text-sm font-bold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{doubt.name}</h4>
                              <span className="dash-mono text-[11px] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{doubt.email}</span>
                            </div>
                          </div>
                          <div className="flex flex-col items-end gap-1.5">
                            ...
                            {!doubt.isAnswered ? (
                              ...
                              <span className="inline-flex items-center gap-1 rounded-full bg-[#F7EFD9] dark:bg-[#362A0D] dark:bg-[#362A0D] dark:bg-[#362A0D] px-2 py-0.5 text-[10px] font-bold text-[#8A6A16]">
                        ...
                        <p className="mt-1.5 rounded-xl border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] p-3.5 text-sm leading-relaxed text-[#3A342E]">{doubt.question}</p>
                          ...
                          <div className="mt-2">
                            {doubt.attachmentDataUrl ? (
                              doubt.attachmentDataUrl.startsWith('data:image/') ? (
                                ...
                                <div className="rounded-xl border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] overflow-hidden">
                                  <img
                                    src={doubt.attachmentDataUrl}
                                    alt={doubt.attachmentName}
                                    className="w-full max-h-48 object-contain bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] cursor-pointer"
                                    onClick={() => {
                                  ...
                                  />
                                  <div className="flex items-center justify-between px-3 py-1.5 bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] border-t border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E]">
                                    <span className="text-[10px] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] truncate">📎 {doubt.attachmentName}</span>
                                    <a
                                ...
                                <div className="flex items-center gap-2.5 rounded-xl border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-3.5 py-2.5">
                              ...
                              <span className="inline-flex items-center gap-1.5 text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
                        ...
                        {doubt.replies && doubt.replies.length > 0 ? (
                          <div className="mt-4 space-y-4">
                            {doubt.replies.map(reply => (
                              <div key={reply.id} className="rounded-xl border border-[#F7EFD9] bg-[#FBF6EA] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] p-4">
                                    ...
                                    {reply.image_urls && reply.image_urls.length > 0 && (
                                      <div className="mt-3 flex flex-wrap gap-2">
                                        {reply.image_urls.map((url, i) => (
                                          <img key={i} src={url} alt="reply attachment" className="h-24 w-auto rounded-lg object-cover shadow-sm border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E]" />
                                        ))}
                                      </div>
                                    )}
                                    {/* Videos */}
                                    {reply.video_urls && reply.video_urls.length > 0 && (
                                      <div className="mt-3 space-y-2">
                                        {reply.video_urls.map((url, i) => (
                                          <video key={i} src={url} controls className="h-40 w-auto rounded-lg shadow-sm border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E]" />
                                        ))}
                                      </div>
                                    )}
                                    {/* Audio */}
                                    ...
                                    {reply.attachment_urls && reply.attachment_urls.length > 0 && (
                                      <div className="mt-3 space-y-2">
                                        {reply.attachment_urls.map((url, i) => (
                                          <a key={i} href={url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-lg border border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-white dark:bg-[#22201F] dark:bg-[#22201F] dark:bg-[#22201F] px-3 py-2 text-xs font-semibold text-[#8A6A16] hover:bg-[#FBF6EA] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726]">
                            ...
                            <div className="mt-4 flex items-center justify-between border-t border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] pt-4">
                          ...
                          <div className="mt-4 rounded-xl border border-[#F7EFD9] bg-[#FBF6EA] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] p-4">
                            <div className="flex items-start gap-2.5">
                              <CornerDownRight size={15} className="mt-0.5 shrink-0 text-[#8A6A16]" />
                              <div className="flex-1">
            ...
            {activeTab === 'announcements' && (
              <div className="space-y-5">
                <div className="flex items-center justify-between">
                  <p className="text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
                    ...
                    {annSorted.map((a) => (
                      <PremiumCard key={a.id} padding="medium" className={a.pinned ? 'ring-1 ring-[#4A0E1B]/15' : ''}>
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <span className="dash-mono shrink-0 text-[11px] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">{fmtDate(a.createdAt)}</span>
                        </div>
                        <h4 className="dash-serif mt-3 text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{a.title}</h4>
                        <p className="mt-1.5 text-sm leading-relaxed text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#C7BCAD]">{a.body}</p>
                        <div className="mt-4 flex items-center gap-1 border-t border-[#F2ECDF] dark:border-[#383330] dark:border-[#383330] dark:border-[#383330] pt-3">
            ...
            {activeTab === 'settings' && (
              <div className="space-y-6">
                <PremiumCard padding="large" accentLine>
                  <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Profile</h3>
                  <p className="text-xs text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">Shown across the professor workspace.</p>
                ...
                <PremiumCard padding="large" accentLine>
                  <h3 className="dash-serif text-lg font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">Data</h3>
                  <p className="mt-1 max-w-xl text-sm leading-relaxed text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#C7BCAD]">
      ...
      {(activeModal === 'add-announcement' || activeModal === 'edit-announcement') && (
        <Modal title={activeModal === 'add-announcement' ? 'New announcement' : 'Edit announcement'} subtitle="Broadcast a notice to everyone in the portal" onClose={closeModal}>
          <form onSubmit={handleAnnouncementSubmit} className="space-y-4">
            ...
            <label className="flex items-center gap-2.5 rounded-xl border border-[#EFE7D8] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726] px-3.5 py-3">
      ...
      {confirm && (
        <Modal title={confirm.title} onClose={() => setConfirm(null)}>
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm leading-relaxed text-[#5A534B] dark:text-[#C7BCAD] dark:text-[#C7BCAD] dark:text-[#C7BCAD]">{confirm.message}</p>
          </div>
...
function ResourceSection({
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91]">
          <span className="font-semibold text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA] dark:text-[#F6F2EA]">{count}</span>
    ...
    <PremiumCard padding="none" className="overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full min-w-[640px] text-left text-sm border-collapse">
          <thead>
            <tr className="border-b border-[#EAE1D2] dark:border-[#4A433E] dark:border-[#4A433E] dark:border-[#4A433E] bg-[#FBF7F0] dark:bg-[#2A2726] dark:bg-[#2A2726] dark:bg-[#2A2726]">
              {head.map((h, i) => (
                <th key={i} className={`px-5 py-3 text-[10px] font-bold uppercase tracking-[0.12em] text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] ${i === head.length - 1 ? 'text-right' : ''}`}>
                  {h}
                </th>
              ))}
            </tr>
...
function RowActions({ onView, onEdit, onDelete }: { onView?: () => void; onEdit: () => void; onDelete: () => void }) {
  return (
    <div className="flex justify-end gap-1">
      {onView && (
        <button onClick={onView} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] transition-colors hover:bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] hover:text-[#4A0E1B]" aria-label="View PDF">
          <Eye size={15} />
        </button>
      )}
      <button onClick={onEdit} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] transition-colors hover:bg-[#F4E7E5] dark:bg-[#38151A] dark:bg-[#38151A] dark:bg-[#38151A] hover:text-[#4A0E1B]" aria-label="Edit">
        <Pencil size={15} />
      </button>
      <button onClick={onDelete} className="rounded-lg p-2 text-[#8A7E6F] dark:text-[#A89F91] dark:text-[#A89F91] dark:text-[#A89F91] transition-colors hover:bg-[#F6E5E1] hover:text-[#B23B2E]" aria-label="Delete">
        <Trash2 size={15} />
      </button>
    </div>
  );
