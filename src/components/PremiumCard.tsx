...
PremiumCard.Description = function CardDescription({ children, className = '' }: CardDescriptionProps) {
  return (
    <p className={`text-[15px] font-normal text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/70 leading-relaxed ${className}`}>
      {children}
    </p>
  );
};
...
PremiumCard.Metadata = function CardMetadata({ children, className = '' }: CardMetadataProps) {
  return (
    <span className={`text-[13px] text-[#22201F] dark:text-[#F6F2EA] dark:text-[#F6F2EA]/60 ${className}`}>
      {children}
    </span>
  );
};
